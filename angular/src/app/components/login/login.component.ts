  ...
  login() {
    ...
    this.loginService.login(this.user).subscribe(
      (response: User) => {
        ...
        document.getElementById("error").innerHTML = "<p class='alert alert-danger'>Login failed! Please check your login details to make sure they're correct.</p>";
      }
    );
  };
  ...
  zodiacInfo() {
    ...
    this.zodiacUser.getMoreInfo(this.name).subscribe(
      (data) => {
        ...
        console.log('failed to retreive zodiac data!')
      }
    )
  };
}
